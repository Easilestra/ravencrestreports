...
export function attachMessage(reportId, messageId, channelId) {
  db.prepare(`UPDATE reports SET message_id = ?, channel_id = ? WHERE id = ?`)
    .run(messageId, channelId, reportId);
}
